                ...
                <div className='bg-[#fff] m-auto lg:py-32'>
                    <div className={ContainerWidth + ' lg:flex gap-10'}>
                        ...
                        <div className='lg:w-[40%]'>
                            ...
                            <p className='text-2xl mt-5 text-[#114466] font-light'>Our CAPM certification training</p>
                            <p className='text-[#006AB0] text-2xl font-bold'>guarantees your exposure to<br/>three vital elements</p>
                        </div>
                        {/* left section */}

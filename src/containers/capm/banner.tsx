        ...
        return (
            <>
                <div className='lg:w-[100%] bg-[#17354a]'>
                    <Image className='lg:relative m-auto' width="1920" height="539" src="/assets/images/capm/capm-banner.jpg" alt='Course' title='Course'/>
                    <div className={ContainerWidth + ' bg-[#17354a] lg:h-auto h-[180px]'}>
                        <div className='absolute left-[100] lg:mt-[-300px] text-white'>
                        <h1 className='lg:text-3xl text-2xl lg:w-[70%] mt-5 !leading-[45px]'>Empower your career ascent with CAPM Certification</h1>

                    ...
                    <div className={ContainerWidth + ' '}>
                        ...
                        <div className="grid lg:grid-cols-2 my-4 justify-center m-auto gap-12 lg:mt-12 mt-10 lg:w-[95%]">
                            ...
                            <div className="text-center flex lg:gap-10 gap-5 lg:border-r-2 border-gray-300">
                                <div className=''><Image className='lg:w-[40px] w-[60px]' width="50" height="50" src="/assets/images/pmp/icons/graduated.png" alt='' title=''/></div>
                                <div className='text-left'>
                                    <p className='font-bold text-[#114466] lg:w-[70%] w-[100%] text-lg leading-6'>For candidates with a Degree or Global Equivalent</p>
                            ...
                            <div className="text-center flex lg:gap-10 gap-5">
                                <div className=''><Image className='lg:w-[60px] w-[80px]' width="60" height="50" src="/assets/images/pmp/icons/management.png" alt='' title=''/></div>
                                <div className='text-left'>

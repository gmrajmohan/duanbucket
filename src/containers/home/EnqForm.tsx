...
import { HomevalidationSchema } from "./HomevalidationSchema";
...
const HomeEnqFrom: FC<CourseEnqFromProps> = ({}) => {
                  ...
                  <div className="mt-3">
                    ...
                    <div
                      className={`flex flex-col space-y-4 md:space-y-0 md:space-x-2 ${
                        errors.stream_id ? "w-[100%] mt-4" : "w-[100%] mt-4"
                      }  md:flex-row`}
                    >
                      <div className="w-[100%]">
                        <Select
                          ...
                          onChange={(event: any) => {
                            handleSelectChange(event, handleChange);
                            GetStreamId(event.target.value);
                          }}
                          onBlur={(event: any) => {
                            handleBlur;
                            seterrMgs("");
                      ...
                      <div
                        className={`${
                          errors.course_id ? "w-[100%] mt-4" : "w-[100%] mt-4"
                        } `}
                      >
                        <Select
                          name="course_id"
                          ...
                          onChange={(event: any) => {
                            handleSelectChange(event, handleChange);
                            CourseList.map((valuess : any)=>( 
                              event.target.value == valuess.id && setCourse(valuess.name) ))
                          }}
                          onBlur={(event: any) => {
                            handleBlur;
                            seterrMgs("");
                    ...
                    <div className="mt-0.5">
                      ...
                      Clicked == true ? (
                        ...
                        <button
                          type="button"
                          className="text-center uppercase text-md text-white px-8 py-3 rounded bg-orange-600 font-light w-[100%] "
                          onClick={() => {
                            handleSubmit();
                            ...
                            };
                            {
                              formValues.name !== "" &&
                                ...
                                formValues.city !== "" &&
                                formValues.city !== "" &&
                                formValues.stream_id.length !== 0 &&
                                formValues.stream_id !== "" &&
                                formValues.stream_id !== "" &&
                                formValues.course_id.length !== 0 &&

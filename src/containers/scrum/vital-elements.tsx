                ...
                <div className='bg-[#fff] m-auto lg:py-32'>
                    <div className={ContainerWidth + ' lg:flex gap-10'}>
                        ...
                        <div className='lg:w-[40%]'>
                            <Image width="450" height="200" src="/assets/images/scrum/vital-vector.png" alt='' title=''/>
                            <p className='text-2xl mt-5 text-[#114466] font-light'>Our Scrum certification training </p>
                            <p className='text-[#FF4B87] text-2xl font-bold'>guarantees your exposure to<br/>three vital elements:</p>
                        </div>
                        {/* left section */}
                        ...
                        <div className='text-[#114466] m-auto lg:max-w-[400px] max-w-[150px] leading-5 lg:w-[50%] lg:my-6 my-20 md:block hidden'>
                            ...
                            <Image className='relative' width="300" height="200" src="/assets/images/scrum/essential-vector.png" alt='' title=''/>
